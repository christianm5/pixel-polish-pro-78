          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              <div className="flex items-center gap-2 text-sm opacity-70">
                <Mail size={14} />
                <span className="font-body">{get("footer", "email", "contact@pasteur-ministry.com")}</span>
              </div>
              <div className="flex items-center gap-2 text-sm opacity-70">
                <Phone size={14} />
                <span className="font-body">{get("footer", "phone", "+243 XXX XXX XXX")}</span>
              </div>
              <div className="flex items-center gap-2 text-sm opacity-70">
                <MapPin size={14} />
                <span className="font-body">{get("footer", "address", "Kinshasa, RD Congo")}</span>
              </div>
            </div>
          </div>
